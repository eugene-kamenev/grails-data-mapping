...
@CompileStatic
class OrientDbMappingContext extends AbstractMappingContext {
    ...
    protected OrientDbGormMappingFactory orientDbGormMappingFactory = new OrientDbGormMappingFactory()
    protected MappingConfigurationStrategy mappingSyntaxStrategy = new GormMappingConfigurationStrategy(mappingFactory);

    OrientDbMappingContext(Closure defaultMapping) {
    ...
    protected PersistentEntity createPersistentEntity(Class javaClass, boolean external) {
        final OrientDbPersistentEntity entity = new OrientDbPersistentEntity(javaClass, this, external);
        return entity;
    }
